...
return (
    ...
    <div className="flex  justify-between">
          <h2 className="font-bold text-xl">Credit Card</h2>
         {!arrow&& <img src="https://secure-media.hotstarext.com/web-assets/prod/images/card-network-icons/visa_master_diner_amex_rupay_x_page.svg" className='justify-end ml-96 w-20'/>}
    ...
    {arrow && content &&<div>
          <form onSubmit={handleSubmit}>
            ...
            <input
                                ...
                                <img src="https://secure-media.hotstarext.com/web-assets/prod/images/card-network-icons/visa_master_diner_amex_rupay_x_page.svg" className='justify-end ml-4 w-20 '/>
            </div>
            <div>
