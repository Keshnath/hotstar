    ...
    <>
      <div className="max-w-4xl   p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div className="flex  justify-between">
          <h2 className="font-bold text-xl">UPI</h2>
        ...
        {arrow&& content &&<div>
          <form onSubmit={handleSubmit}>
            <div className="relative z-0 mb-6 group border border-gray-300 rounded w-80 mt-2">
              <input
                type="email"
                name="Upi"
                id="floating_email"
          ...
          <p>
            You'll be charged ₹899 once every year until<br></br> you cancel
          </p>
        </div>}
      </div>
    </>
