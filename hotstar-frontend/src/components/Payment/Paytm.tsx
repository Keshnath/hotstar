...
const Paytm = () => {
  ...
  return (
   ...
   <div className="flex  justify-between">
          <h2 className="font-bold text-xl">Paytm Wallet</h2>
         {!arrow&& <img src="https://secure-media.hotstarext.com/web-assets/prod/images/paytmLogo.svg" className='justify-end ml-96 w-9'/>}
    ...
    {arrow && content &&<div>
          <form onSubmit={handleSubmit}>
            ...
            <input
                                ...
                                >
                                    Registered Number on Paytm
                                </label>
                                <img src="https://secure-media.hotstarext.com/web-assets/prod/images/paytmLogo.svg" className='justify-end ml-9 w-9 '/>
            </div>
            <button
              type="submit"
